...
export default function BtnAksi(users) {
  const [btnLove, setBtnlove] = useState('gray');
  const [btnComent, setBtnComent] = useState('gray');
  const [btnRetwet, setBtnRetwet] = useState('gray');
  ...
  return (
    <div className="mt-2 flex w-[95%] justify-around cursor-pointer">
      ...
      <div className="flex items-center gap-1">
        <button onClick={coment}>
          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill={btnComent} class="bi bi-chat-square" viewBox="0 0 16 16">
      ...
      {/* retwet */}
      <div className="flex items-center gap-1">
        <button onClick={retwet}>
          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill={btnRetwet} class="bi bi-repeat" viewBox="0 0 16 16">
      ...
      <div className="flex items-center gap-1">
        <button onClick={like}>
          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill={btnLove} class="bi bi-heart" viewBox="0 0 16 16">
